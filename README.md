# [Bitfinex](https://www.bitfinex.com/) [PyAlgoTrade](http://gbeced.github.io/pyalgotrade/) Module
...
The LiveFeed class can be plugged just as any other bar feed in PyAlgoTrade. To subscribe for bid and ask prices, just call ```getOrderBookUpdateEvent().subscribe(<your_callback_function>)``` from the LiveFeed instance. Kindly see example at sample.py.
...
This is based on Bitstamp and Xignite module of PyAlgoTrade.
